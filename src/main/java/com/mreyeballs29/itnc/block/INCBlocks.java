...
public class INCBlocks {
	...
	public static final Block LEAD_FRAME = new FrameBlock(Properties.from(LEAD_BLOCK).hardnessAndResistance(2.5F, 3.0F).notSolid()).setRegistryName("itnc", "lead_frame");
