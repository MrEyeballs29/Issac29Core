...
public class Isacc29Core {
	...
	public static final IProxy object = DistExecutor.unsafeRunForDist(() -> ClientProxy::new, () -> ServerProxy::new);
	...
	public void onServerStarting(FMLServerStartingEvent event) {
		...
		World world1 = event.getServer().getWorld(DimensionType.OVERWORLD);
		Isacc29Core.world = world1;
	...
	public void onCommonSetup(FMLCommonSetupEvent ev) {
		...
		if (Config.LEAD_GENERATE.get().booleanValue()) OreGeneration.addCommonOre(INCBlocks.LEAD_ORE, 9, 12, 68, 0, 0);
		...
		if (Config.NETHER_GOLD_GENERATE.get().booleanValue()) OreGeneration.addNetherOre(INCBlocks.NETHER_GOLD_ORE, 9, 12, 100, 10, 20);
		if (Config.NETHER_IRON_GENERATE.get().booleanValue()) OreGeneration.addNetherOre(INCBlocks.NETHER_IRON_ORE, 9, 9, 90, 15, 0);
		if (Config.NETHER_COPPER_GENERATE.get().booleanValue()) OreGeneration.addNetherOre(INCBlocks.NETHER_COPPER_ORE, 9, 10, 100, 18, 15);
