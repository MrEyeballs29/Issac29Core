...
public class EntityFallingPowder extends EntityFallingBlock {

	public EntityFallingPowder(World worldIn) {
		super(worldIn);
	}
	
	public EntityFallingPowder(World worldIn, double x, double y, double z, IBlockState fallingBlockState) {
		super(worldIn, x, y, z, fallingBlockState);
	}

	@Override
	public void onUpdate() {
		IBlockState block = this.getBlock();
		if (block == null) {
          Issac29Core.log.error(block);
		}
