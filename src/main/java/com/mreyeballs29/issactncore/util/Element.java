...
public class Element extends Object {
	...
	public static final Element SAND = new Element("sand", 441);
	public static final Element RSAND = new Element("red_sand", 442);
	...
	public boolean nameIsSame(Element oth) {
		return oth.name.equalsIgnoreCase(this.name);
	}
